...
class TestAgregarVehiculos extends ConsumerStatefulWidget {
  static final String name = "TestAgregarVehiculos";
  const TestAgregarVehiculos({Key? key}) : super(key: key);

  @override
  _TestAgregarVehiculos createState() => _TestAgregarVehiculos();
}

class _TestAgregarVehiculos extends ConsumerState<TestAgregarVehiculos> {
  ...
  // PARA DESACTIVAR Y ACTIVAR BOTON
  void _validateForm() {
    setState(() {
  ...
  // METODO PARA VALIDAR LAS PATENTES
  ...
  // METODO PARA GUARDAR DATOS DEL VEHICULO EN FIRESTORE
