...
class HistorialReservasUsuario extends ConsumerStatefulWidget {
  static final String name = 'HistorialReservasUsuario';
  const HistorialReservasUsuario({super.key});

  @override
  _HistorialReservasUsuariosState createState() =>
      _HistorialReservasUsuariosState();
}

class _HistorialReservasUsuariosState
    extends ConsumerState<HistorialReservasUsuario> {
  @override
...
class _ListView extends ConsumerWidget {
  ...
  Future<List<Reserva>> _fetchReservas(WidgetRef ref) async {
    ...
    QuerySnapshot<Map<String, dynamic>> snapshot = await firestore
        ...
        .where('fueAlGarage', isEqualTo: true)
        .where('seRetiro', isEqualTo: true)
        .get();
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    context.push('/cargarComentarioReserva');
                  },
                ),
              );
            },
